...
const HvacTrading = () => {
  ...
  return (
    <Layout>
      ...
      {/* HVAC Solutions Tabs */}
      <AnimatedSection id="hvac-tabs" className="py-12 md:py-24 bg-white scroll-mt-24" animationType="fade-in-up">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-12 text-gray-300 animate-fade-in-up stagger-2">
              Let's discuss your project requirements and find the perfect HVAC and MEP solutions for your needs.
            </p>
            <div 
