    ...
    sections: [
      {
        ...
        products: [
          { name: "Teak Wood", image: getImg("Teak Wood.webp"), category: "Interior" },
          { name: "Meranti", image: getImg("Meranti Wood.webp"), category: "Interior" },
          { name: "Iroko", image: getImg("Iroko Wood.webp"), category: "Interior" },
          { name: "Mahogany", image: getImg("Mahogany Wood.webp"), category: "Interior" },
          { name: "Dabema", image: getImg("Dabema Wood.webp"), category: "Interior" },
          { name: "Oak", image: getImg("Oak Wood.webp"), category: "Interior" },
          { name: "Okume", image: getImg("Okume Wood.webp"), category: "Interior" },
          { name: "Merbau", image: getImg("Merbau Wood.webp"), category: "Interior" },
          { name: "Balau", image: getImg("Balau Wood.webp"), category: "Interior" },
        ]
      },
      {
        ...
        products: [
          { name: "Pine", image: getImg("Pine Wood.webp"), category: "Construction" },
          { name: "Spruce", image: getImg("Spruce Wood.webp"), category: "Construction" },
          { name: "SYP Timber", image: getImg("SYP Timber.webp"), category: "Construction" },
        ]
      }
    ]
  },
    ...
    sections: [
      {
        ...
        products: [
          { name: "BWP", image: getImg("BWP Plywood.webp"), category: "Interior" },
          { name: "MR Grade", image: getImg("MR Grade Plywood.webp"), category: "Interior" },
        ]
      },
      {
        ...
        products: [
          { name: "Film Face Shutter", image: getImg("Film Face Shutter Plywood.webp"), category: "Construction" },
        ]
      }
    ]
  },
    ...
    sections: [
      {
        ...
        products: [
          { name: "MR Grade", image: getImg("MR Grade MDF.webp"), category: "MDF" },
          { name: "HMR MDF", image: getImg("HMR MDF.webp"), category: "MDF" },
          { name: "Laminated MDF", image: getImg("Laminated MDF.webp"), category: "MDF" },
        ]
      },
      {
        title: "Chipboard",
        ...
        products: [
          { name: "Laminated", image: getImg("Laminated Chipboard.webp"), category: "Chipboard" },
          { name: "Plain", image: getImg("Plain Chipboard.webp"), category: "Chipboard" },
        ]
      }
    ]
  },
    ...
    sections: [
      {
        ...
        products: [
          { name: "Handle", image: getImg("Door Handle.webp"), category: "Door" },
          { name: "Pull Handles", image: getImg("Pull Handles Door.webp"), category: "Door" },
          { name: "Locks", image: getImg("Door Locks.webp"), category: "Door" },
          { name: "Cylinders and Key", image: getImg("Cylinders and Key.webp"), category: "Door" },
          { name: "Hinges", image: getImg("Door Hinges.webp"), category: "Door" },
          { name: "Panic Hardware", image: getImg("Panic Hardware.webp"), category: "Door" },
          { name: "Accessories", image: getImg("Door Accessories.webp"), category: "Door" },
        ]
      },
      {
        ...
        products: [
          { name: "Hinges", image: getImg("Furniture Hinges.webp"), category: "Furniture" },
          { name: "Runners", image: getImg("Drawer Runners.webp"), category: "Furniture" },
          { name: "Handles", image: getImg("Furniture Handles.webp"), category: "Furniture" },
          { name: "Cabinet Accessories", image: getImg("Cabinet Accessories.webp"), category: "Furniture" },
          { name: "Cabinet Knobs", image: getImg("Cabinet Knobs.webp"), category: "Furniture" },
        ]
      },
      {
        ...
        products: [
          { name: "Spring", image: getImg("Glass Spring.webp"), category: "Glass" },
          { name: "Patch Fittings", image: getImg("Patch Fittings.webp"), category: "Glass" },
          { name: "Pull Handles", image: getImg("Glass Pull Handles.webp"), category: "Glass" },
          { name: "Glass Door Locks", image: getImg("Glass Door Locks.webp"), category: "Glass" },
          { name: "Hinges", image: getImg("Glass Hinges.webp"), category: "Glass" },
          { name: "Shower Fittings", image: getImg("Shower Fittings.webp"), category: "Glass" },
        ]
      }
    ]
  }
