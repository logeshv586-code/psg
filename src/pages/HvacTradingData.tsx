    ...
    sections: [
      {
        ...
        products: [
          { name: "Non Rising Stem - Lead Free Brass", image: getImg("Non-rising-stem-Lead-free-gate-valve-150x150.webp"), category: "Gate Valves" },
          { name: "Non Rising Stem - Brass", image: getImg("BRASS-GATE-VALVE-150x150.webp"), category: "Gate Valves" },
          { name: "Lockshield - Brass", image: getImg("LOCK-SHIELD-GATE-VALVE-150x150.webp"), category: "Gate Valves" },
          { name: "Rising Stem - Cast Iron", image: getImg("RISING-STEM-GATE-VALVE-150x150.webp"), category: "Gate Valves" },
          { name: "Non Rising Stem - Cast Iron", image: getImg("NON-RISING-DI-GATE-VALVE-150x150.webp"), category: "Gate Valves" },
        ]
      },
      {
        ...
        products: [
          { name: "Lug Type", image: getImg("LUG-TYPE-BF-VALVE-150x150.webp"), category: "Butterfly Valves" },
          { name: "Wafer Type", image: getImg("WAFER-TYPE-BF-VALVE-150x150.webp"), category: "Butterfly Valves" },
          { name: "Flanged Type", image: getImg("FLANGED-TYPE-GEAR-OPERATED-BF-VALVE-150x150.webp"), category: "Butterfly Valves" },
          { name: "Centric", image: getImg("CENTRIC-BF-VALVE-150x150.webp"), category: "Butterfly Valves" },
          { name: "Double Eccentric", image: getImg("DOUBLE-ECCENTRIC-BF-VALVE-150x150.webp"), category: "Butterfly Valves" },
        ]
      },
      {
        title: "Ball Valves",
        ...
        products: [
          { name: "Bronze Ball Valve", image: getImg("BRONZE-BALL-VALVES-150x150.webp"), category: "Ball Valves" },
          { name: "Brass Ball Valve", image: getImg("BRASS-BALL-VALVE-150x150.webp"), category: "Ball Valves" },
          { name: "DZR Brass Ball Valve", image: getImg("DZR-BALL-VALVE-150x150.webp"), category: "Ball Valves" },
          { name: "Cast Iron Ball Valve", image: getImg("CAST-IRON-BALL-VALVE-150x150.webp"), category: "Ball Valves" },
          { name: "Ductile Iron Ball Valve", image: getImg("DUCTILE-IRON-BALL-VALVE-150x150.webp"), category: "Ball Valves" },
        ]
      },
      {
        title: "Check Valves",
        ...
        products: [
          { name: "Swing Check Valve - Lead Free Brass", image: getImg("Swing Check Valve Natural.webp"), category: "Check Valves" },
          { name: "Lift Check Valve - Brass", image: getImg("LIFT-CHECK-VALVE-BRASS-150x150.webp"), category: "Check Valves" },
          { name: "Swing Check Valve - Brass", image: getImg("Brass Swing Check Valve 1.webp"), category: "Check Valves" },
          { name: "Dual Plate Check Valve - Cast Iron", image: getImg("Dual Plate Check Valve Cast Iron.webp"), category: "Check Valves" },
          { name: "Dual Plate Check Valve", image: getImg("Dual Plate Check Valve.webp"), category: "Check Valves" },
        ]
      },
      {
        title: "Strainers",
        ...
        products: [
          { name: "Y Type Strainers - Brass", image: getImg("Y Type Strainers Brass.webp"), category: "Strainers" },
          { name: "Y Type - DSR Bronze", image: getImg("Y Type DSR Bronze.webp"), category: "Strainers" },
          { name: "Y Type Strainers - Bronze", image: getImg("Y Type Strainers Bronze.webp"), category: "Strainers" },
          { name: "Y Type Strainers - Cast Iron", image: getImg("Y Type Strainers Cast Iron.webp"), category: "Strainers" },
          { name: "Basket Type Strainers - Cast Iron", image: getImg("Basket Type Strainers Cast Iron.webp"), category: "Strainers" },
        ]
      },
      {
        ...
        products: [
          { name: "Flexible Connection", image: getImg("Flexible Connection.webp"), category: "Connectors" },
          { name: "Rubber Expansion Joints", image: getImg("Rubber Expansion Joints.webp"), category: "Connectors" },
          { name: "Tied Flanged", image: getImg("Tied Flanged.webp"), category: "Connectors" },
        ]
      },
      {
        ...
        products: [
          { name: "Fixed Orifice - DZR Brass", image: getImg("Fixed Orifice DZR Brass.webp"), category: "Balancing Valves" },
          { name: "Variable Orifice - DZR Brass", image: getImg("Variable Orifice DZR Brass.webp"), category: "Balancing Valves" },
          { name: "Double Regulating Valve - Cast Iron", image: getImg("Double Regulating Valve Cast Iron.webp"), category: "Balancing Valves" },
        ]
      },
      {
        title: "PICV",
        ...
        products: [
          { name: "Linear Characteristic PICV", image: getImg("Linear Characteristic PICV.webp"), category: "PICV" },
          { name: "Equal Percentage PICV", image: getImg("Equal Percentage PICV.webp"), category: "PICV" },
          { name: "Ductile Iron PICV", image: getImg("Ductile Iron PICV.webp"), category: "PICV" },
        ]
      },
      {
        ...
        products: [
          { name: "Servo - Activated", image: getImg("Servo Activated Solenoid.webp"), category: "Solenoid" },
        ]
      },
      {
        ...
        products: [
          { name: "Watts Intelligent Control Valves", image: getImg("Watts Intelligent Control Valves.webp"), category: "Control Valves" },
        ]
      },
      {
        title: "Relief Valves",
        ...
        products: [
          { name: "Pressure Relief Valve", image: getImg("Pressure Relief Valve.webp"), category: "Valves" },
        ]
      },
      {
        title: "Pumps",
        ...
        products: [
          { name: "HVAC Pumps", image: getImg("HVAC Pumps.webp"), category: "Pumps" },
        ]
      },
      {
        ...
        products: [
          { name: "DSR Brass", image: getImg("DSR Brass Valve.webp"), category: "HVAC" },
          { name: "Cast Iron", image: getImg("Cast Iron Valve.webp"), category: "HVAC" },
        ]
      },
      {
        ...
        products: [
          { name: "FCU Valve Package", image: getImg("FCU Valve Package.webp"), category: "HVAC" },
        ]
      },
      {
        ...
        products: [
          { name: "Axial Type Exhaust Fans", image: getImg("Axial Exhaust Fan.webp"), category: "Fans" },
          { name: "Centrifugal Type Exhaust Fans", image: getImg("Centrifugal Exhaust Fan.webp"), category: "Fans" },
          { name: "Inline Fresh Air Fans", image: getImg("Inline Fresh Air Fan.webp"), category: "Fans" },
          { name: "Single Inlet Exhaust Fans", image: getImg("Single Inlet Exhaust Fan.webp"), category: "Fans" },
        ]
      },
      {
        title: "Fire Dampers",
        ...
        products: [
          { name: "Fusible Fire Dampers", image: getImg("Fusible Fire Damper.webp"), category: "Dampers" },
          { name: "Motorised Fire Dampers", image: getImg("Motorised Fire Damper.webp"), category: "Dampers" },
        ]
      },
      {
        ...
        products: [
          { name: "Manual VCD", image: getImg("Manual VCD.webp"), category: "Air Distribution" },
          { name: "Motorised VCD", image: getImg("Motorised VCD.webp"), category: "Air Distribution" },
          { name: "VAV", image: getImg("VAV Box.webp"), category: "Air Distribution" },
          { name: "Diffusers and Grills", image: getImg("Diffusers and Grills.webp"), category: "Air Distribution" },
        ]
      },
      {
        title: "HVAC Sensors",
        ...
        products: [
          { name: "Water Flow Switch", image: getImg("Water Flow Switch.webp"), category: "Sensors" },
          { name: "Indoor Air Quality Sensor", image: getImg("Indoor Air Quality Sensor.webp"), category: "Sensors" },
          { name: "Pressure Sensor", image: getImg("Pressure Sensor.webp"), category: "Sensors" },
          { name: "Humidistat", image: getImg("Humidistat.webp"), category: "Sensors" },
          { name: "Temperature Sensor", image: getImg("Temperature Sensor.webp"), category: "Sensors" },
          { name: "Differential Pressure Switch", image: getImg("Differential Pressure Switch.webp"), category: "Sensors" },
          { name: "Temperature & Humidity Sensor", image: getImg("Temperature _ Humidity Sensor.webp"), category: "Sensors" },
          { name: "Clean Room Monitor Sensor", image: getImg("Clean Room Monitor.webp"), category: "Sensors" },
        ]
      },
      {
        title: "Thermostat",
        ...
        products: [
          { name: "Thermostat", image: getImg("Thermostat.webp"), category: "Controls" },
        ]
      },
      {
        title: "Air Vents",
        ...
        products: [
          { name: "Air Vent", image: getImg("Air Vent.webp"), category: "Vents" },
        ]
      },
      {
        title: "BTU Meter",
        ...
        products: [
          { name: "BTU Meter", image: getImg("BTU Meter.webp"), category: "Meters" },
        ]
      },
      {
        ...
        products: [
          { name: "Hydronic Flow Meter", image: getImg("Hydronic Flow Meter.webp"), category: "Meters" },
        ]
      },
      {
        ...
        products: [
          { name: "Water Leak Detection System", image: getImg("Water Leak Detection System.webp"), category: "Safety" },
        ]
      },
      {
        ...
        products: [
          { name: "Thermal Insulation", image: getImg("Thermal Insulation.webp"), category: "Insulation" },
          { name: "Acoustic Insulation", image: getImg("Acoustic Insulation.webp"), category: "Insulation" },
        ]
      },
      {
        ...
        products: [
          { name: "DUC Insulation", image: getImg("DUC Insulation Adhesive.webp"), category: "Insulation" },
        ]
      },
      {
        title: "VFD",
        ...
        products: [
          { name: "Variable Frequency Drive", image: getImg("Variable Frequency Drive.webp"), category: "Drives" },
        ]
      },
      {
        title: "UPS System",
        ...
        products: [
          { name: "UPS System", image: getImg("UPS System.webp"), category: "Power" },
        ]
      }
    ]
  },
    ...
    sections: [
      {
        ...
        products: [
          { name: "Gate Valves", image: getImg("Gate Valves.webp"), category: "Fire Valves" },
          { name: "Butterfly Valve", image: getImg("Butterfly Valve.webp"), category: "Fire Valves" },
          { name: "Check Valves", image: getImg("Check Valves.webp"), category: "Fire Valves" },
        ]
      },
      {
        ...
        products: [
          { name: "Fire Hydrant System", image: getImg("Fire Hydrant System.webp"), category: "Hydrant" },
        ]
      },
      {
        ...
        products: [
          { name: "Ductile Iron Pipes", image: getImg("Ductile Iron Pipes.webp"), category: "Pipes" },
        ]
      },
      {
        title: "Fire Cables",
        ...
        products: [
          { name: "Fire Resistant Cables", image: getImg("Fire Cables.webp"), category: "Cables" },
        ]
      },
      {
        ...
        products: [
          { name: "Digital Voice Command", image: getImg("Digital Voice Command.webp"), category: "Alarm" },
          { name: "Alarm Cable", image: getImg("Alarm Cable.webp"), category: "Alarm" },
          { name: "Alarm Module", image: getImg("Alarm Module.webp"), category: "Alarm" },
          { name: "Alarm Panel", image: getImg("Alarm Panel.webp"), category: "Alarm" },
          { name: "Fire Detector", image: getImg("Fire Detector.webp"), category: "Alarm" },
          { name: "Hooter", image: getImg("Hooter.webp"), category: "Alarm" },
          { name: "Manual Call Point", image: getImg("Manual Call Point.webp"), category: "Alarm" },
        ]
      },
      {
        title: "VESDA System",
        ...
        products: [
          { name: "VESDA System", image: getImg("VESDA System.webp"), category: "System" },
        ]
      },
      {
        ...
        products: [
          { name: "Inter Lock", image: getImg("Inter Lock.webp"), category: "Pre Action" },
          { name: "Double Inter Lock", image: getImg("Double Inter Lock.webp"), category: "Pre Action" },
          { name: "Potter Release", image: getImg("Potter Release.webp"), category: "Pre Action" },
          { name: "Pre Action System", image: getImg("Pre Action System.webp"), category: "Pre Action" },
          { name: "Interlock - Dry Pilot", image: getImg("Interlock Dry Pilot.webp"), category: "Pre Action" },
          { name: "Double Interlock Electric", image: getImg("Double Interlock Electric.webp"), category: "Pre Action" },
          { name: "Interlock - Wet Pilot", image: getImg("Interlock Wet Pilot.webp"), category: "Pre Action" },
        ]
      },
      {
        ...
        products: [
          { name: "Pressure Gauge", image: getImg("Pressure Gauge.webp"), category: "Sprinkler" },
          { name: "Recessed Sprinkler", image: getImg("Recessed Sprinkler.webp"), category: "Sprinkler" },
          { name: "Side Wall Sprinkler", image: getImg("Side Wall Sprinkler.webp"), category: "Sprinkler" },
          { name: "Sprinkler Guard", image: getImg("Sprinkler Guard.webp"), category: "Sprinkler" },
          { name: "Swing Check", image: getImg("Swing Check Sprinkler.webp"), category: "Sprinkler" },
          { name: "Test and Drain", image: getImg("Test and Drain.webp"), category: "Sprinkler" },
          { name: "Upright Sprinkler", image: getImg("Upright Sprinkler.webp"), category: "Sprinkler" },
          { name: "Vertical Side Wall", image: getImg("Vertical Side Wall.webp"), category: "Sprinkler" },
          { name: "Water Motor Gong", image: getImg("Water Motor Gong.webp"), category: "Sprinkler" },
          { name: "Y Strainer", image: getImg("Y Strainer.webp"), category: "Sprinkler" },
          { name: "Zone Controlled Manifold", image: getImg("Zone Controlled Manifold.webp"), category: "Sprinkler" },
          { name: "Butterfly Valve", image: getImg("Butterfly Valve Sprinkler.webp"), category: "Sprinkler" },
          { name: "Concealed Sprinkler", image: getImg("Concealed Sprinkler.webp"), category: "Sprinkler" },
          { name: "Conventional Sprinkler", image: getImg("Conventional Sprinkler.webp"), category: "Sprinkler" },
          { name: "Flow Switch", image: getImg("Flow Switch.webp"), category: "Sprinkler" },
          { name: "Gate Valve", image: getImg("Gate Valve Sprinkler.webp"), category: "Sprinkler" },
          { name: "Pendant Sprinkler", image: getImg("Pendant Sprinkler.webp"), category: "Sprinkler" },
        ]
      },
      {
        ...
        products: [
          { name: "CO2 Gas Suppression System", image: getImg("CO2 Gas Suppression System.webp"), category: "Suppression" },
        ]
      },
      {
        title: "Novec System",
        ...
        products: [
          { name: "Novec System", image: getImg("Novec System.webp"), category: "Suppression" },
        ]
      },
      {
        ...
        products: [
          { name: "Fire Fighting Pumps", image: getImg("Fire Fighting Pumps.webp"), category: "Pumps" },
        ]
      }
    ]
  },
    ...
    sections: [
      {
        ...
        products: [
          { name: "PVC Pipes and Fittings", image: getImg("PVC Pipes and Fittings.webp"), category: "Pipes" },
        ]
      },
      {
        ...
        products: [
          { name: "CPVC Pipes and Fittings", image: getImg("CPVC Pipes and Fittings.webp"), category: "Pipes" },
        ]
      },
      {
        ...
        products: [
          { name: "UPVC Pipes and Fittings", image: getImg("UPVC Pipes and Fittings.webp"), category: "Pipes" },
        ]
      },
      {
        ...
        products: [
          { name: "PPR Pipes and Fittings", image: getImg("PPR Pipes and Fittings.webp"), category: "Pipes" },
        ]
      }
    ]
  },
    ...
    sections: [
      {
        ...
        products: [
          { name: "Electric Panel Cables", image: getImg("Electric Panel Cables.webp"), category: "Cables" },
          { name: "Power Cables", image: getImg("Power Cables.webp"), category: "Cables" },
          { name: "Armoured Cables", image: getImg("Armoured Cables.webp"), category: "Cables" },
          { name: "Rubber Cables", image: getImg("Rubber Cables.webp"), category: "Cables" },
          { name: "Halogen-Free Cables", image: getImg("Halogen-Free Cables.webp"), category: "Cables" },
          { name: "Fire-Resistant Cables", image: getImg("Fire-Resistant Cables.webp"), category: "Cables" },
          { name: "Control Cables", image: getImg("Control Cables.webp"), category: "Cables" },
          { name: "Instrumentation Cables", image: getImg("Instrumentation Cables.webp"), category: "Cables" },
          { name: "Solar Cables", image: getImg("Solar Cables.webp"), category: "Cables" },
          { name: "Aluminium Cables", image: getImg("Aluminium Cables.webp"), category: "Cables" },
        ]
      },
      {
        ...
        description: "",
        products: [
          { name: "MCBs", image: getImg("MCBs.webp"), category: "Breakers" },
          { name: "MCCB", image: getImg("MCCB.webp"), category: "Breakers" },
          { name: "ACB", image: getImg("ACB.webp"), category: "Breakers" },
          { name: "Insulated Case Circuit Breakers", image: getImg("Insulated Case Circuit Breakers.webp"), category: "Breakers" },
        ]
      }
    ]
  }
