  ...
  return (
    <section id="business-section" className="py-16 lg:py-24 bg-background">
      <div className="container mx-auto px-4 lg:px-8">
        <MotionSection className="grid gap-6 sm:gap-8 lg:grid-cols-2 lg:items-start lg:gap-16">
          <div>
        ...
        <div className="mt-8 sm:mt-10 lg:mt-14 grid gap-4 sm:gap-6 lg:grid-cols-3 lg:grid-rows-2">
          <div className="grid gap-6 lg:row-span-2 lg:grid-rows-2">
            <MotionItem delay={0.1} className="h-full">
              <Link
                to="/environmental"
                className="group relative block overflow-hidden rounded-2xl min-h-[180px] sm:min-h-[220px] lg:min-h-0 h-full"
                style={{
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-transparent transition-opacity duration-300 group-hover:opacity-90" />
                <div className="relative flex h-full flex-col justify-between p-4 sm:p-6 transition-transform duration-300 group-hover:scale-[1.02]">
                  <div>
            ...
            <MotionItem delay={0.2} className="h-full">
              <Link
                to="/software"
                className="group relative block overflow-hidden rounded-2xl min-h-[220px] lg:min-h-0 h-full"
                style={{
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-black/75 via-black/45 to-transparent transition-opacity duration-300 group-hover:opacity-90" />
                <div className="relative flex h-full flex-col justify-between p-6 transition-transform duration-300 group-hover:scale-[1.02]">
                  <div>
          ...
          <MotionItem delay={0.3} className="lg:row-span-2 h-full">
            <Link
              to="/construction"
              className="group relative block overflow-hidden rounded-2xl min-h-[260px] lg:min-h-0 h-full"
              style={{
            ...
            >
              ...
              <div className="relative flex h-full flex-col items-center justify-center p-8 text-center transition-transform duration-300 group-hover:scale-[1.02]">
          ...
          <div className="grid gap-6 lg:row-span-2 lg:grid-rows-2">
            <MotionItem delay={0.4} className="h-full">
              <Link
                to="/tourism"
                className="group relative block overflow-hidden rounded-2xl min-h-[220px] lg:min-h-0 h-full"
                style={{
            ...
            <MotionItem delay={0.5} className="h-full">
              <Link
                to="/digital-health"
                className="group relative block overflow-hidden rounded-2xl min-h-[220px] lg:min-h-0 h-full"
                style={{
