...
const usefulLinks = [
  ...
  { label: "Construction & Interior Supplies", href: "/construction" },
  ...
  return (
    <footer className="bg-primary text-primary-foreground">
      ...
      <div className="container mx-auto px-4 lg:px-8 py-12">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 mb-12 pb-12 border-b border-primary-foreground/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <p className="text-sm text-primary-foreground/70 leading-relaxed">
              Prime Source Global delivers innovative solutions in timber
              trading, household hardware, MEP services, digital health,
              tourism, and software development. We focus on sustainability and
              excellence to empower businesses and enrich lives.
            </p>
