...
const Chatbot: React.FC = () => {
  ...
  const handleRobotClick = () => {
    ...
    if (!isOpen && robotRef.current) {
      ...
      // Dimensions match the CSS classes: sm:w-[380px] and sm:h-[600px]
      const chatWidth = isSmallScreen ? windowWidth - 32 : 380; // w-[calc(100vw-2rem)] = 100vw - 32px
      const chatHeight = isSmallScreen ? windowHeight - 192 : 600; // h-[calc(100vh-12rem)] = 100vh - 192px
  ...
  return (
    <>
      ...
      >
        <div className="w-[calc(100vw-2rem)] sm:w-[380px] h-[calc(100vh-12rem)] sm:h-[600px] bg-[#09090b] text-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-zinc-800 ring-1 ring-black/5 font-sans cursor-default">
          
          <div className="flex items-center justify-between px-4 py-3 bg-[#8CC63F] text-[#172033] border-b border-[#7ab332]/50">
          ...
          <div className="p-4 bg-white border-t border-gray-200">
            <div className="flex items-center gap-1.5 bg-gray-50 p-1.5 pl-3 pr-1.5 rounded-[24px] border border-gray-200 focus-within:border-gray-300 transition duration-300">
